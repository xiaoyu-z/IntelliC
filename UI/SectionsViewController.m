...
//    UIButton *upload = [[UIButton alloc]initWithFrame:CGRectMake(0, self.view.bounds.size.height, self.view.frame.size.width,20)];
//    [upload setTitle:@"upload" forState:UIControlStateNormal];
//    [upload addTarget:self action:@selector(clickUpload) forControlEvents:UIControlEventTouchDown];
//    [upload setTintColor:[UIColor blackColor]];
//    [table addSubview:upload];
